...
function index(props) {
  ...
  // 小车的朝向
  const forwardOrient = "bottomLeft"
  ...
  return (
    <div className={myCityVisible ? "deep" : "deep hide"}>
      {/*  可视区域 */}
      <div className="visible-area" >
        {/* 路标 */}
        <RoadSign style={{ left: -229, bottom: 73 }} cnName={"深入交通路"} enName={"Into Traffic Road"}></RoadSign>
        {/* 左侧树木&景观 */}
